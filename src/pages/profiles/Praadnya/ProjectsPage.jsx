...
const getProjectImage = (projectName) => {
  const imageMap = {
    'Multimodal Advertisement Generator': animatrixImage,
    'CuisineCompass': zomatoImage,
    'Employee Leave Management System': leaveImage,
    'Medical Clinic Website': clinicImage
  };
